...
# For some reason if microchip is already on the users path then this silly install will muck up the existing paths.
# Need to manually correct the much up until a work around.

INSTALL_DIR="/opt"

URL="https://ww1.microchip.com/downloads/aemDocuments/documents/DEV/ProductDocuments/SoftwareTools/MPLABX-v6.15-linux-installer.tar"
REFERER="https://www.microchip.com/en-us/tools-resources/develop/mplab-x-ide#"
...
wget -O "$INSTALL_DIR/mplab.tar" --referer=$REFERER $URL
